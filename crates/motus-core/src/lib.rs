//! # motus-core
//!
//! Core traits and easing system for the Motus animation library.
//!
//! This crate is the foundation every other Motus crate builds on.
...
//!
//! ```rust
//! use motus_core::{Interpolate, Easing};
//!
