...
fn App() -> impl IntoView {
    ...
    let trigger_viewport = trigger.clone();
        ...
        <main style=PAGE_STYLE>
            <section style=INTRO>
                ...
                <div style=STATUS_GRID>
                    ...
                    <Stat label="Viewport" value=move || format!("{:.0}%", trigger_viewport.progress().get() * 100.0) />
                </div>
            </section>
            ...
            >
                <div style=TARGET_HEADER>
                    ...
                    <strong>{move || format!("{:.0}%", progress.get() * 100.0)}</strong>
                </div>
